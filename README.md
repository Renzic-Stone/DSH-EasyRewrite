...
| 撤回（Recall） | ✅ | 基本功能 |
| **惰性提交**（确认后才真正修改 context，中途退出零改动） | ✅ | 部分直接改 |
| **无痕替换**（归档 + 同名顶替，感知上就是"原对话被编辑了"） | ✅ | 少见 |
| **版本翻页器 < X >**（切换历史版本 + 归档交换，侧栏只留一个活动版本） | ✅ | 目前市面竞品完全无同类功能 |
| **草稿持久化 + 超时自动备份 + 异常恢复** | ✅ | 目前市面竞品完全无同类功能 |
| **编辑重发保留图片附件** | ✅ | 目前市面竞品完全无同类功能 |
| **纯官方扩展点**（零源码补丁，卸载即还原） | ✅ | 部分依赖源码补丁 |
| 三语界面与 i18n 支持 | ✅ | 多数没有 |
| 全部功能可按需开关 | ✅ | 少数 |
