...
// ---------- 滚动锚定：已交还官方 chatScrollPositions（按会话原生保存/恢复滚动位，review #4 删自建轮子） ----------
    ...
    function EditModelPicker(props) {
      ...
      var chipStyle = { display: "flex", alignItems: "center", gap: "4px", border: "none", background: "transparent", cursor: "pointer", borderRadius: "24px", outline: "none", height: "28px", padding: "0 4px 0 8px", fontSize: "13px", fontWeight: 500, lineHeight: "20px", color: "var(--dsw-alias-label-secondary)", minWidth: "0" };
      ...
      var chevron = React.createElement("svg", {
        ...
        style: { color: "var(--dsw-alias-label-caption, var(--dsw-alias-label-tertiary))", flex: "none", transition: "transform .12s", transform: menuOpen ? "rotate(180deg)" : "none" }
      }, React.createElement("path", { d: "M9 6l6 6-6 6", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }));
      var body;
      if (view === "root") {
        body = [
      ...
      return React.createElement("div", { ref: rootRef, style: { display: "inline-block" } },
        React.createElement("button", {
          ...
          React.createElement("span", { style: { fontWeight: 500, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" } }, modelLabel),
