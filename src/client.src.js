  ...
  factory: function (require) {
    ...
    function RecallBanner(props) {
      ...
      React.useEffect(function () {
        ...
        bar.style.cssText = "display:flex;align-items:center;gap:8px;margin:0 16px;border-bottom:1px solid var(--dsw-alias-border-l2,rgba(128,128,128,0.25));padding:2px 10px 6px;";
