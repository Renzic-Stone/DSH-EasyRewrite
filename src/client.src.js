  ...
  factory: function (require) {
    ...
    function RecallBanner(props) {
      ...
      React.useEffect(function () {
        ...
        // flex:1 让标签占满剩余空间，把 × 推到最右
        label.style.cssText = "font-size:12px;color:var(--dsw-alias-label-secondary);line-height:18px;background:var(--dsw-alias-interactive-bg-hover,rgba(128,128,128,0.12));border-radius:999px;padding:1px 10px;flex:1;";
